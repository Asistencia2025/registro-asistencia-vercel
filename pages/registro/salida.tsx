...
export default function RegistroSalida() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    const registro = { proyecto, coordinador, sst, operarios, tipo: "Salida" };
  ...
  return (
    <div style={{ display: "flex", justifyContent: "center", marginTop: "30px" }}>
      <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "10px", width: "400px", background: "#ffc107", padding: "20px", borderRadius: "12px", color: "#000" }}>
        ...
        <button type="submit" style={{ padding: "10px", borderRadius: "6px", background: "#198754", color: "#fff" }}>Registrar Salida</button>
      </form>
    </div>
  );
}
